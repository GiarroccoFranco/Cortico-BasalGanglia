...
packets(3).real = Acc_Val_WithinArm;         packets(3).shuf = Shuf_Val_WithinArm;         packets(3).timeVec = timeVec_Obj;
packets(4).real = Acc_Val_TrainEye_TestArm;  packets(4).shuf = Shuf_Val_TrainEye_TestArm;  packets(4).timeVec = timeVec_Obj;
